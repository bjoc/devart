(function($) {
  resizeMe = function() {
    ...
    if (mobile) {
      ...
      setTimeout(function() {
        $(".d").each(function() {
          var descHeight = $(this).find(".desc").outerHeight(true);
          var descTop = $(this).find(".desc").position().top;
          var allHeight = descHeight * 1.1 + descTop;
          if ($(this).attr("id") == "div3") allHeight += 300;
          $(this).css("height", allHeight);
        });
      }, 100);

      $(".list").css("top", 100 * scale);
      $(".think").css("top", 310 * scale);
      $(".desc").css("top", 500 * scale);
...
(function($) {
  initMe = function() {
    ...
    preloadimages(preImg).done(function(images) {
      ...
      TweenLite.to(["#wrapper, #pic1Cont, #pic2Cont, #footer, #header"], 0.3, {
        opacity: 1
      });
...
(function($) {
  div1ON = function() {
    ...
    if (whichAnim == 0) TweenLite.to(["#footer"], 0.3, {
      width: wi - 1,
    ...
    TweenLite.to(["#win1", "#win1p"], 0.3, {
      width: 320 * scale,
      left: 80 * scale,
      top: 5 * scale,
      ease: Power2.easeInOut
    });
    TweenLite.to(["#win2", "#win2p"], 0.2, {
      width: 240 * scale,
      left: 0,
      top: 0,
      ease: Power2.easeInOut
    });
    TweenLite.to(["#win3", "#win3p"], 0.2, {
      width: 240 * scale,
      left: 0,
      top: 0,
      ease: Power2.easeInOut
    ...
    TweenLite.to(["#div1", "#think1"], 0.3, {
      width: maxwi,
      ease: Power2.easeInOut
    });
    TweenLite.to(["#div2", "#think2"], 0.3, {
      width: minwi,
      ease: Power2.easeInOut
    });
    TweenLite.to(["#div3", "#think3"], 0.3, {
      width: minwi - 1,
      ease: Power2.easeInOut
    });

    TweenLite.to("#think1", 1, {
      color: colorMyOrange,
      scale: 1
    });
    TweenLite.to("#think2", 1, {
      color: colorMyWhite,
      scale: 1
    });
    TweenLite.to("#think3", 1, {
      color: colorMyBlack,
      scale: 1
    });

    TweenLite.to(["#win1p, #win1c"], 0.2, {
      opacity: 1.0
    });
    TweenLite.to(["#win2p, #win2c"], 0.2, {
      opacity: 0.6
    });
    TweenLite.to(["#win3p, #win3c"], 0.2, {
      opacity: 0.1
    });

    TweenLite.to(["#list1"], 0.5, {
      opacity: 1
    });
    TweenLite.from(["#list1"], 0.8, {
      left: maxwi / 2
    });
    TweenLite.to(["#desc1"], 0.8, {
      opacity: 1
    });
    TweenLite.to(["#list2", "#desc2"], 0.2, {
      opacity: 0
    });
    TweenLite.to(["#list3", "#desc3"], 0.2, {
      opacity: 0
    });

    TweenLite.to("#win3p", 1, {
      scale: 0.8,
      ease: Power2.easeInOut
    });
    TweenLite.to("#win2p", 1, {
      scale: 0.8,
      ease: Power2.easeInOut
    });
    TweenMax.to("#win1p", 3, {
...
(function($) {
  div2ON = function() {
    ...
    if (whichAnim == 0) TweenLite.to(["#footer"], 0.4, {
      width: wi - 1,
      ease: Power2.easeInOut
    });
    ...
    TweenLite.to(["#win2", "#win2p"], 0.3, {
      width: 320 * scale,
      left: 80 * scale,
      top: 5 * scale,
      ease: Power2.easeInOut
    });
    TweenLite.to(["#win1", "#win1p"], 0.2, {
      width: 240 * scale,
      left: 0,
      top: 0,
      ease: Power2.easeInOut
    ...
    TweenLite.to(["#list1", "#desc1"], 0.2, {
      opacity: 0
    });
    TweenLite.to(["#list2"], 0.5, {
      opacity: 1
    });
    TweenLite.from(["#list2"], 0.8, {
      left: maxwi / 2
    });
    TweenLite.to(["#desc2"], 0.8, {
      opacity: 1
    });
    TweenLite.to(["#list3", "#desc3"], 0.2, {
      opacity: 0
...
(function($) {
  div3ON = function() {
    ...
    TweenLite.to(["#list3"], 0.5, {
      opacity: 1
    });
    TweenLite.from(["#list3"], 0.8, {
      left: maxwi / 2
    });
    TweenLite.to(["#desc3"], 0.8, {
      opacity: 1
    });
...
(function($) {
  divAllOFF = function() {
    ...
    TweenLite.to(["#win2p, #win2c"], 0, {
      opacity: 0.6
    });

    TweenLite.to(".think", 0, {
      color: colorMyBlack,
      scale: 1
    });
    TweenLite.to("#think2", 0, {
      color: colorMyWhite,
      scale: 1
    });
    TweenLite.to(["#win1p"], 0, {
      scale: 0.8
    });
    TweenLite.to(["#win2p"], 0, {
      scale: 0.8
    });
    TweenLite.to(["#win3p"], 0, {
      scale: 0.8
    });
...
(function($) {
  divMobileON = function() {
    ...
    TweenLite.from(["#list1", "#list2", "#list3"], 0, {
      left: maxwi / 2
    });
...
(function($) {
  initOtherActions = function() {
    ...
    $(".refCont").on("mouseenter", function() {
      TweenMax.to($(this).find(".refImg"), 8, {
        scale: 1.2,
        ease: Power2.easeOut
      });
    }).on("mouseleave", function() {
      TweenMax.to($(this).find(".refImg"), 0.3, {
        scale: 1,
        ease: Power2.easeOut
      });
    });

...
(function($){ initMe = function() {
	...
	preloadimages(preImg).done(function(images){
		...
		TweenLite.to(["#wrapper, #pic1Cont, #pic2Cont, #footer, #header"], 0.3, { opacity:1});
...
(function($){ div1ON = function() {
	...
	if (whichAnim == 0)  TweenLite.to(["#footer"], 0.3, { width: wi-1, ease:Power2.easeInOut });

	$("#win1p").attr("src", "images/_win1p.jpg");
	$("#win2p").attr("src", "images/_win2pB.jpg");
	$("#win3p").attr("src", "images/win3pB.jpg");

	TweenLite.to(["#win1", "#win1p"], 0.3, {width:320*scale, left:80*scale, top: 5*scale, ease:Power2.easeInOut });
	...
	TweenLite.to(["#win3", "#win3p"], 0.2, {width:240*scale, left:0, top: 0, ease:Power2.easeInOut });
 	...
 	TweenLite.to(["#div1","#think1"], 0.3, { width: maxwi, ease:Power2.easeInOut });
	TweenLite.to(["#div2","#think2"], 0.3, { width: minwi, ease:Power2.easeInOut });
	TweenLite.to(["#div3","#think3"], 0.3, { width: minwi-1, ease:Power2.easeInOut });
	...
	TweenLite.to(["#list1"], 0.5, { opacity: 1});
	TweenLite.from(["#list1"], 0.8, { left: maxwi/2});
	TweenLite.to(["#desc1"], 0.8, { opacity: 1});
...
(function($){ div2ON = function() {
	...
	TweenLite.to(["#win2", "#win2p"], 0.3, {width:320*scale, left:80*scale, top: 5*scale, ease:Power2.easeInOut });
	TweenLite.to(["#win1", "#win1p"], 0.2, {width:240*scale, left:0, top: 0, ease:Power2.easeInOut });
	TweenLite.to(["#win3", "#win3p"], 0.2, {width:240*scale, left:0, top: 0, ease:Power2.easeInOut });

  	TweenLite.to(["#div1","#think1"], 0.3, { width: minwi, ease:Power2.easeInOut });
  	TweenLite.to(["#div2","#think2"], 0.3, { width: maxwi, ease:Power2.easeInOut });
  	TweenLite.to(["#div3","#think3"], 0.3, { width: minwi-1, ease:Power2.easeInOut });
  	...
  	TweenLite.to(["#list2"], 0.5, { opacity: 1});
  	TweenLite.from(["#list2"], 0.8, { left: maxwi/2});
  	TweenLite.to(["#desc2"], 0.8, { opacity: 1});
  	TweenLite.to(["#list3", "#desc3"], 0.2, { opacity: 0});
...
(function($){ div3ON = function() {
	...
	TweenLite.to(["#win3", "#win3p"], 0.3, {width:320*scale, left:80*scale, top: 5*scale, ease:Power2.easeInOut });
	TweenLite.to(["#win2", "#win2p"], 0.2, {width:240*scale, left:0, top: 0, ease:Power2.easeInOut });
	TweenLite.to(["#win1", "#win1p"], 0.2, {width:240*scale, left:0, top: 0, ease:Power2.easeInOut });

   	TweenLite.to(["#div1","#think1"], 0.3, { width: minwi, ease:Power2.easeInOut });
  	TweenLite.to(["#div2","#think2"], 0.3, { width: minwi, ease:Power2.easeInOut });
  	TweenLite.to(["#div3","#think3"], 0.3, { width: maxwi-1, ease:Power2.easeInOut });
  	...
  	TweenLite.to(["#list1", "#desc1"], 0.2, { opacity: 0});
  	TweenLite.to(["#list2", "#desc2"], 0.2, { opacity: 0});
  	TweenLite.to(["#list3"], 0.5, { opacity: 1});
  	TweenLite.from(["#list3"], 0.8, { left: maxwi/2});
  	TweenLite.to(["#desc3"], 0.8, { opacity: 1});
...
(function($){ divAllOFF = function() {
	...
	scalePics();
  	...
  	// TweenLite.to(".el", 0, { scale: 0});
		...
		TweenLite.to("#think2", 0, { color: colorMyWhite, scale: 1 });
